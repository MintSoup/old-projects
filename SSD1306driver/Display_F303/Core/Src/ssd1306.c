...
#ifdef FPS_TEST
static uint8_t SSD1306_WB[SSD1306_WIDTH * SSD1306_HEIGHT / 8];
static uint8_t SSD1306_BB[SSD1306_WIDTH * SSD1306_HEIGHT / 8];
#endif
// Screen object
...
void ssd1306_black(void) {
	...
	HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40, 1, SSD1306_BB,
			sizeof(SSD1306_Buffer), HAL_MAX_DELAY);

}

void ssd1306_white(void) {
	// Write data to each page of RAM. Number of pages
	// depends on the screen height:
	//
	//  * 32px   ==  4 pages
	...
	HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40, 1, SSD1306_WB,
			sizeof(SSD1306_Buffer), HAL_MAX_DELAY);
